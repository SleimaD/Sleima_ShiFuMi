...
export default function Result(props) {
  ...
  return (
    <div className="result-container mt-[7rem] flex text-white justify-center items-center gap-[10rem] max-[400px]:gap-0">
        ...
        <div className="result-message flex flex-col justify-normal items-center gap-5 max-[400px]:mt-[8rem]">
            <p className=' max-[400px]:me-[3rem] font-bold max-[400px]:text-[2rem]'>  {props.choices[props.userChoice].beats === props.computerChoice ? 'You Win' : (props.choices[props.userChoice].beats === props.computerChoice ?  ' You Lose' : 'DRAW')}</p>
